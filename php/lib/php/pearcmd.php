...
if ('/home/victor/wordpress-5.2.3-0/php/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/home/victor/wordpress-5.2.3-0/php/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
